...
<div class="card" style="margin:20px;">
  <div class="card-header text-center font-weight-bold h3">Pedido número: {{ $order->id }}</br>
  </div>
  <div class="card-body">
    <div class="card-body">
...
<a href="{{ route('order.lista-user') }}" class="" title="Volver"><button class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i>Volver</button></a>
@endsection